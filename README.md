...
Modern cloud-based file transfer systems require users to trust service providers with sensitive data. While end-to-end encryption enhances confidentiality, it often eliminates server-side visibility entirely, limiting the ability to detect abnormal or potentially harmful usage patterns. This project investigates how structured metadata analysis can provide operational insight without exposing file content.
...
Risk-informed analysis of design decisions

Critical assessment of trade-offs and system limitations

Project Phases

AT2 – Challenge Definition: Research framing, literature review, methodology justification, requirements engineering, risk management, system design.

AT3 – Software Demonstration: Implementation of encrypted transfer, metadata logging, anomaly detection, and monitoring dashboard.

AT4 – Project Review: Verification, validation, performance evaluation, architectural trade-off analysis, and critical reflection.
